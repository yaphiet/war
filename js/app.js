...
function deal() {
	...
	img.src = ("/card-deck-css/images" + playerHand[0] + ".svg");
	img2.src = ("/card-deck-css/images" + compHand[0] + ".svg");
...
function warToArray() {
	...
	for (var i = 0; i < length; i++) {
		...
		compHand.shift();
		cardStr += '<img src="css/GOT CARD.png">';
	}

	//set up the War visual with relevant cards
	$(".playerWarFinal").html("<img src='card-deck-css/images/"+playerHand[0]+".svg'>").animateCss("flipInYRev");
	$(".playerWarCards").html(cardStr);
	$(".compWarCards").html(cardStr);
	$(".compWarFinal").html("<img src='card-deck-css/images/"+compHand[0]+".svg'>").animateCss("flipInY");
...
function preloadImages() {
	for (var i = 0; i < 52; i++) {
		var img = new Image();
		img.src = 'card-deck-css/images/'+i+'.svg';
	}
}